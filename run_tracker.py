...
# output: none
def run_tracker(image_list, tracker_type, frame_connector, coords_list=None, video_fps=4, overwrite_image=False):
...
if __name__ == "__main__":
    ...
    simple_list = [[(0,0),(1,0)], [(7,8),(8,8),(9,8),(10,8)], [(2,3),(4,5),(5,5)]]      # warning: there are more CPFrames than items in this list

    run_tracker(img_list, TRACKER_TYPE, frame_connector, coords_list=None, video_fps=VIDEO_FPS, overwrite_image=False)
